            ...
            <div class="col-md-2 col-sm-4 hidden-xs">
                <div class="footer-title">
                    <div class="text-uppercase">
                        <h4><img class="img-responsive footer-logo" src="img/1-w.png" alt="California"></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="content-wrap widget-gallery">
                    <div class="lightbox-gallery">
                        <a target="_blank" href="img/big_1.jpg">
                            <img class="img-responsive" src="img/1.jpg" alt=""/>
                        </a>
                        <a target="_blank" href="img/big_3.jpg">
                            <img class="img-responsive" src="img/3.jpg" alt=""/>
                        </a>
                        <a target="_blank" href="img/big_8.jpg">
                            <img class="img-responsive" src="img/8.jpg" alt=""/>
                        </a>
                        <a target="_blank" href="img/big_9.jpg">
